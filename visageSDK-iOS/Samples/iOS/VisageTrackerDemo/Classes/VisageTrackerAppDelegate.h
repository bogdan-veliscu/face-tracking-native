 ...
 *
 * The VisageTrackerDemo sample project demonstrates real-time head/facial features tracking from camera, video file or image based on the VisageSDK::VisageTracker tracker class.
 *
