...
public:
	...
	* An example of use:
	* \code
	* VisageFaceRecognition *m_VFR = new VisageFaceRecognition("bdtsdata/NN");
	* //
...
#endif
	/** Constructor.
	* @param dataPath path to the folder containing the data files required for face recognition function. 
	In the Visage|SDK distribution, this is the folder: Samples/data/bdtsdata/NN.
	*/
	...
	*
	* std::string dataPathFaceRecognition("../Samples/data/bdtsdata/NN");
