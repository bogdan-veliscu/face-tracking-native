...
extern "C" {
	...
	/** Initializes new camera with the given camera information (argument orientation currently not used).
	 */
	...
	/** Starts face tracking on current frame and returns tracker status.
	 */
