...
BEGIN_MESSAGE_MAP(CFaceDetectorApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CFaceDetectorApp::OnAppAbout)
...
BOOL CFaceDetectorApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CFaceDetectorDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CFaceDetectorView));
	if (!pDocTemplate)
		return FALSE;
...
void CFaceDetectorApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
...
// CFaceDetectorApp message handlers
