...
public class CameraActivity extends UnityPlayerActivity {
    public final String TAG = "FRAME_JAVA";
    ...
    public static CameraActivity currentActivity;
    ...
    public void GrabFromCamera(int imWidth, int imHeight, int pickCamera) {
        ...
        Log.i(TAG, "#### getPreferredPreviewSizeForVideo " + preferedSize.height + " | " + preferedSize.height);
        ...
        cam.setPreviewCallbackWithBuffer(new PreviewCallback() {
            ...
            public void onPreviewFrame(byte[] data, Camera camera) {
                ...
                FrameRendererPlugin.draw(data, ImageWidth, ImageHeight, orientation);
            }
        });
        cam.startPreview();
        openCam = true;
    ...
    public void closeCamera() {
        Log.i(TAG, "#### closeCamera :" + (cam != null));
    ...
    public int startScanner(int nativeCode) {
        Log.i(TAG, "#### Start QR scanner with code:" + nativeCode);
        ...
        Log.i(TAG, "#### Start QR scanner with code: -> After async task started" + nativeCode);
        return 0;
    }
    ...
    private void startScannerTask() {
        ...
        barcodeDetector.setProcessor(new Detector.Processor<Barcode>() {
            ...
            public void receiveDetections(Detector.Detections<Barcode> detections) {
                ...
                if (barcodes.size() != 0) {
                    ...
                    //FrameRendererLib.onCodeDetected(qrCode, rect.top, rect.left, rect.bottom, rect.right);
        ...
        try {
            ...
            FrameRendererPlugin.setScannerEnabled(1);
                ...
                if (cameraSource != null) {
                    cameraSource.release(new Runnable() {
                        ...
                        public void run() {
                            ...
                            FrameRendererPlugin.setScannerEnabled(0);
                        }
                    });
                    cameraSource = null;
                }
